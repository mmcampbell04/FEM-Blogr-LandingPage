...
})({"84IIr":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "0ea9660614213a3d";
"use strict";
...
},{}],"jDlmx":[function(require,module,exports) {
...
function toggleDropdown(dropdown) {
    if (dropdown.classList.contains("active")) {
        ...
        for (let activeDropdown of activeDropdowns)activeDropdown.classList.remove("active");
        dropdown.classList.add("active");
        window.screen.width <= 976 ? mobileMenu.style.boxShadow = "-9px 36px 20px var(--dropdown-background)" : mobileMenu.style.boxShadow = "none";
    }
}
...
for (let dropdown of dropdowns){
    ...
    dropdown.addEventListener("blur", function(event) {
        if (!this.contains(event.relatedTarget)) this.classList.remove("active");
    }, true);
}

},{}]},["84IIr","jDlmx"], "jDlmx", "parcelRequire6519")

//# sourceMappingURL=index.14213a3d.js.map
